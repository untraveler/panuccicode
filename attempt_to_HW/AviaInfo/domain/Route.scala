...
object Route extends Enumeration {
  ...
  val AIRLINE, AIRLINE_ID, SOURCE_AIRPORT, SOURCE_AIRPORT_ID, TARGET_AIRPORT, TARGET_AIRPORT_ID, CODESHARE, STOPS, EQUIPMENT = Value
  val structType = StructType(
    Seq(
      ...
      StructField(CODESHARE.toString, StringType),
